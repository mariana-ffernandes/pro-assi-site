...
import IntroductionContentPage from '@/pages/IntroductionContent.vue';
import FrequentlyQuestionsPage from '@/pages/FrequentlyQuestionsPage.vue';
import FrequentlyQuestionsContent from '@/pages/FrequentlyQuestionsContent.vue';
...
const routes = [
  ...
  {
    path: '/conteudo-introducao/:moduleId', 
    name: 'IntroductionContent',
    component: IntroductionContentPage,       
    props: true                             
  },
  {
  ...
  {
    path: '/frequently-questions-content/:videoUrl', 
    name: 'FrequentlyQuestionsContent',
    component: FrequentlyQuestionsContent,
    props: true
  }
];
