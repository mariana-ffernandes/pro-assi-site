  ...
  <div class="introduction-page">
    ...
    <main>
      <div class="buttons-container">
        <button class="button-perda-auditiva" @click="goToModule(1)">Módulo 1</button>
        <button class="button-funcao-aparelho" @click="goToModule(2)">Módulo 2</button>
      </div>
    </main>
  </div>
</template>
...
export default {
  ...
  methods: {
    goToModule(moduleId) {
      this.$router.push({ name: 'IntroductionContent', params: { moduleId } });
    }
  }
}
</script>
